...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{proj/png/1BP_draw.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{proj//png/BP1_sim.png}
    \caption{Symulowana charakerystyka filtru}
\end{figure}
